...
\footnote{\texttt{lecture\_material\_5.pdf}の68ページ参照.
}
...
\begin{enumerate}   
    ...
    \begin{itemize}
        ...
        \item 本設問における採点対象は，数値結果をまとめた表のみである．レポートに自身の作成したプログラムを記載する必要はない．
    \end{itemize}
\end{enumerate}
